import { View, Text, StyleSheet, FlatList, TouchableOpacity, Dimensions, Alert, Image, ScrollView } from "react-native";
        ...
        <View style={styles.content}>
            ...
            {categories
              ...
              .map((category) => (
                ...
                >
                  ...
                  {category.photo && (
                    <Image
                      source={{ uri: `${POS_URL}${category.photo}` }} // Ajoute le début de l'URL
          ...
          <View style={styles.menuGrid}>
            <FlatList
              ...
              numColumns={3} // Affiche 3 éléments par ligne
              ...
              renderItem={({ item }) => (
                ...
                >
                  ...
                  {item.photo && (
                    <Image
                      source={{ uri: `${POS_URL}${item.photo}` }} // Ajoute le début de l'URL
